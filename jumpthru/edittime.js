function GetBehaviorSettings()
{
	return {
		...
		"id":			"jumpthru",
		"version":		"1.0",
		"description":	"A solid the Platform behavior can also jump on to from underneath.",
		"author":		"Scirra",
...
AddComboParam("State", "Set whether the object counts as a platform or not.", 1);
AddAction(0, 0, "Set enabled", "", "Set {my} <b>{0}</b>", "Set whether the object counts as a platform or not.", "SetEnabled");
