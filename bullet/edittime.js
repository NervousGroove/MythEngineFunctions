...
AddNumberParam("Distance", "The new distance in pixels to set for the DistanceTravelled expression.");
AddAction(6, 0, "Set distance travelled", "", "Set {my} distance travelled to <i>{0}</i>", "Change the counter used to track the distance travelled.", "SetDistanceTravelled");
