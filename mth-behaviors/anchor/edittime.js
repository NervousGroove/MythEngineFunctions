...
{
	return {
		"name":			"Anchor",			// as appears in 'add behavior' dialog, can be changed as long as "id" stays the same
		"id":			"Anchor",			// this is used to identify this behavior and is saved to the project; never change it
		"version":		"1.0",
		"description":	"Position objects relative to the size of the window.",
		"author":		"Scirra",
		"help url":		"http://www.scirra.com/manual/88/anchor",
...
AddAction(0, 0, "Set enabled", "", "Set {my} {0}", "Enable or disable the behavior.", "SetEnabled");
