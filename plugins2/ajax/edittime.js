...
AddCondition(3,	cf_trigger, "On any completed", "AJAX", "On any completed", "Triggered when any AJAX request completes successfully. The 'Tag' expression identifies the request.", "OnAnyComplete");

AddCondition(4,	cf_trigger, "On any error", "AJAX", "On any error", "Triggered when any AJAX request fails. The 'Tag' expression identifies the request.", "OnAnyError");
...
AddExpression(2, ef_return_string, "", "AJAX", "Tag", "Get the tag for the request in a trigger.");
