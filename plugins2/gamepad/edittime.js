...
AddComboParamOption("Button A");
AddComboParamOption("Button B");
AddComboParamOption("Button X");
AddComboParamOption("Button Y");
AddComboParamOption("Left shoulder button");
AddComboParamOption("Right shoulder button");
AddComboParamOption("Left shoulder trigger");
AddComboParamOption("Right shoulder trigger");
AddComboParamOption("Back / View");
AddComboParamOption("Start / Menu");
AddComboParamOption("Left analog button");
AddComboParamOption("Right analog button");
AddComboParamOption("D-pad up");
AddComboParamOption("D-pad down");
AddComboParamOption("D-pad left");
AddComboParamOption("D-pad right");
