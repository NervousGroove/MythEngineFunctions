...
{
	return {
		"name":			"Scirra Arcade",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"ScirraArcade",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":		"Submit hi-scores on the Scirra Arcade.",
		"author":		"Scirra",
...
AddAction(0, af_none, "Submit score", "Arcade", "Submit hi-score of <b>{0}</b>", "Submit a new hi-score to the Scirra Arcade for this game.", "SubmitSingleScore");
