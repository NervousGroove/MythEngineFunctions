function GetPluginSettings()
{
	return {
		...
		"description":	"Send and receive text messages to a WebSocket server.",
		"author":		"Scirra",
...
AddCondition(0, cf_trigger, "On opened", "Connection", "On connection opened", "Triggered when the connection to the WebSocket server is successfully established.", "OnOpened");
...
AddAction(0, af_none, "Connect", "Connection", "Connect to <i>{0}</i> (require protocol {1})", "Connect to a WebSocket server.", "Connect");

AddAction(1, af_none, "Close", "Connection", "Close connection", "Close any active WebSocket connection.", "Close");
