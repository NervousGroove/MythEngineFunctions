...
AddAction(2, af_deprecated, "Log in", "Facebook", "Log in (request <i>{0}</i>, <i>{1}</i>)", "Log the user in to the application so their details can be accessed.", "LogIn");
...
AddAction(5, 0, "Prompt to share this app", "Prompt (no permissions required)", "Prompt to share this app", "Bring up a dialog where the user can share a link to the app on their wall or choose to cancel.", "PromptToShareApp");

AddStringParam("URL", "The link to share.", "\"http://\"");
AddAction(6, 0, "Prompt to share link", "Prompt (no permissions required)", "Prompt to share link <b>{0}</b>", "Bring up a dialog where the user can share a link on their wall or choose to cancel.", "PromptToShareLink");
...
AddStringParam("Permissions", "Requested permissions, separated by a comma. E.g. \"public_profile,publish_actions,user_games_activity\".");
AddAction(12, 0, "Log in", "Facebook", "Log in (permissions: <i>{0}</i>)", "Log the user in to the application so their details can be accessed.", "LogIn2");
...
AddExpression(7, ef_return_number | ef_deprecated, "Get user ID", "Facebook", "UserID", "Get the user's ID, which is different even for users with the same name.");

AddExpression(8, ef_return_number | ef_deprecated, "Get hi-score user ID", "Scores (when logged in with permission)", "HiscoreUserID", "Get the user ID of the user with hi-score, when in an 'on hi-score' event.");

AddExpression(9, ef_return_string, "", "Facebook", "UserIDStr", "Get the user's ID as a string, which is different even for users with the same name.");

AddExpression(10, ef_return_string, "", "Scores (when logged in with permission)", "HiscoreUserIDStr", "Get the user ID string of the user with hi-score, when in an 'on hi-score' event.");
