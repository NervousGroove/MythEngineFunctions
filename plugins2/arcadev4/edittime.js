...
AddStringParam("Leaderboard ID", "The ID of the leaderboard on the Scirra Arcade.");
AddNumberParam("Score", "The score this player achieved.");
AddAction(0, af_none, "Submit score", "Arcade", "Submit hi-score of <b>{1}</b> to leaderboard <i>{0}</i>", "Submit a new hi-score to the Scirra Arcade for this game.", "SubmitScore");
