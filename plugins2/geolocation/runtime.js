...
(function ()
{
	...
	Acts.prototype.RequestLocation = function (accuracy_, timeout_, maxage_)
	{
		...
		// Geolocation doesn't work in NW.js (presumably Google's services block anything that doesn't look like Google Chrome).
		// As a workaround, directly use the Google Geolocation API.
