...
{
	return {
		"name":			"Dictionary",			// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"Dictionary",			// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"Store data under named keys, e.g. set \"key\" to \"value\".",
		"author":		"Scirra",
...
AddAction(4, 0, "Load", "JSON", "Load from JSON string <i>{0}</i>", "Load from a dictionary previously encoded in JSON format.", "JSONLoad");
